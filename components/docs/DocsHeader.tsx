  ...
  return (
    <section className="max-w-4xl">
      <div className="mb-5 flex items-center gap-3">
        <span className="rounded-full bg-[#0f7c83] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-white">
          Official Docs
        </span>
      ...
      <h1 className="max-w-3xl text-4xl font-black tracking-tight text-slate-950 md:text-6xl">
        Master your <span className="text-[#4b53c8]">focus infrastructure.</span>
      </h1>
      ...
      <div className="relative mt-10 max-w-3xl">
        ...
        <input
          ...
          className="h-15 w-full rounded-2xl border border-slate-200 bg-white pl-12 pr-24 text-sm text-slate-900 shadow-[0_8px_30px_rgba(15,23,42,0.05)] outline-none transition focus:border-[#4b53c8] focus:ring-4 focus:ring-[#4b53c8]/10"
        />
